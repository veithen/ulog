...
public class Test extends TestCase {
    ...
    protected void setUp() throws Exception {
        // Normally an application would get the logger via the SLF4J API, but since this is what we
        // want to
        // test here, we can't do that.
        ch.qos.logback.classic.Logger logger =
                (ch.qos.logback.classic.Logger)
                        StaticLoggerBinder.getSingleton().getLoggerFactory().getLogger("test");
    ...
    public void testCommonsLogging() {
        ...
        log.info(msg);
        assertThat(appender.getLastEvent().getMessage()).isEqualTo(msg);
    }
